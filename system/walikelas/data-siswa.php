					...
					<div class="col-md-6" align="right">
						<nav>
							<ul class="pagination">
								...
								<a class='page-link' href='page.php?w-data-siswa&kelas=$nm_kelas&pg=$link' aria-label='Previous'>
								...
								$nmr.= "<li class='page-item'><a class='page-link' href='page.php?w-data-siswa&kelas=$nm_kelas&pg=$i'>$i</a></li>";
								}
								}
								...
								<a class='page-link' href='page.php?w-data-siswa&kelas=$nm_kelas&pg=$link'aria-label='Next'>
