...
<?= '<title>Tambah Siswa - MARI-ABSEN</title>' >?;
					...
					<div class="row">
						<form id="form-insert" name="form-insert" action="page.php?process-insert-siswa" enctype="multipart/form-data" method="POST">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="form-label" for="insert-nama_ortu"><i class="font-icon font-icon-user"></i> Nama Orang Tua</label>
									<div class="form-control-wrapper">
										<input id="insert-nama_ortu" class="form-control" name="nama_ortu" placeholder="Nama Orang Tua" type="text"
										data-validation="[L>=1]"
