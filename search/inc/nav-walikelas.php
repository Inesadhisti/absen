<body class="with-side-menu">
	<header class="site-header">
	    <div class="container-fluid">
	        <a href="../page.php?w-home" class="site-logo">
	...
	<nav class="side-menu">
	    ...
	    <ul class="side-menu-list">
	        ...
	        <li class="blue with-sub">
	            <span>
	            <i class="font-icon font-icon-list-square"></i>
	            <span class="lbl">Lihat Absensi Sholat</span>
	            </span>
	            <ul>
	            <li>
				<?php 
			...
			<li class="yellow">
	            <a href="../page.php?rekap-absensi">
	            <i class="font-icon font-icon-server"></i>
	            <span class="lbl">Rekap Absensi</span>
	            </a>
	        </li>

	        <li class="yellow">
	            <a href="../page.php?rekap-absensi-sholat">
	            <i class="font-icon font-icon-server"></i>
	            <span class="lbl">Rekap Absensi Sholat</span>
	            </a>
	        </li>
